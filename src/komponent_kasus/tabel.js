              ...
              <tbody>
                {daftar.map((item, index) => (
                  <tr key={index} className={`${index % 2 === 0 ? "bg-white" : "bg-gray-100"} hover:bg-yellow-100 transition`}>
                    <td className="border-2 w-[20vw] border-gray-400 px-4 py-1 font-medium">{item.LP}</td>
                    <td className="border-2 w-[20vw] border-gray-400 px-4 py-1">{item.jenis}</td>
                    <td className="border-2 w-[20vw] border-gray-400 px-4 py-1 text-right">{item.pelapor}</td>
                    <td className="border-2 w-[20vw] border-gray-400 px-4 py-1 text-right  font-semibold">{item.status}</td>
                    <td className="border-2 w-[20vw] border-gray-400 px-4 py-1 text-right  font-semibold">{item.penyidik}</td>
                  </tr>
                ))}
             </tbody>
          </table>
